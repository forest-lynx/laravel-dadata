...
use ForestLynx\DaData\Enums\Gender;
use ForestLynx\DaData\Enums\Parts;
use ForestLynx\DaData\Facades\DaDataName;
use ForestLynx\DaData\Facades\DaDataPassport;

/**
 * Class DaDataPassportTest
 * @package ForestLynx\DaData\Tests
 */
